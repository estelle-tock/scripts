...
./import_configuration.sh demo 3677 10511.prod.proto

# FINAL DEMO (RESOS & GUESTS)
nohup ./run_importer.sh -e demo -b 3677 -g ../../bellavita.csv -r ../../empty.txt -c "{formatVersion:OPENTABLE_GUESTCENTER,separator:',', resoDateFormat:YYYY_M_D_DASH,resoTimeFormat:H_M_A, guestDateFormat: YYYY_M_D_DASH, quoteDetectionEnabled: false, smsReminderEnabled: false}" &
