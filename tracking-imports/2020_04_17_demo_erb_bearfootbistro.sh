...
# ----------------- BUSINESS DETAILS ----------------------
#
# Business Name - Bearfoot Bistro
# Demo ID - 3344
# Reminder Texts - true
# Welcome Texts - false
# Export Configurations - false
#
# ------------------- DATA DETAILS -----------------------
#
...
# Reservation file name - bearfootbistro_resos.csv 
# Guest file name - bearfootbistro_guests.csv
#
# --------------------------------------------------------
...
./export_configuration.sh prod 10561 10561.prod.proto
./import_configuration.sh demo 3344 10561.prod.proto
./import_configuration.sh demo 3345 10561.prod.proto

# DEMO (RESOS & GUESTS)
./run_importer.sh -e demo -b 3344 -g ../../bearfoot_guests_from_resos.txt -r ../../bearfoot_erb_resos.txt -c "{formatVersion:OPENTABLE_ERB, resoDateFormat:D_M_YYYY, resoTimeFormat:H_M,resoCreationDateFormat:D_M_YYYY, quoteDetectionEnabled: false, smsReminderEnabled: false}"
...
--config_json="{formatVersion:OPENTABLE_CUSTOM,separator:',', resoDateFormat:YYYY_M_D_DASH,resoTimeFormat:H_M_A, quoteDetectionEnabled: false, smsReminderEnabled: true}"

./run_importer.sh -e demo -b 3344 -g ../../bearfoot_7rooms_resos.csv -r ../../empty.txt -c "{formatVersion:OPENTABLE_CUSTOM,separator:',', resoDateFormat:YYYY_M_D_DASH,resoTimeFormat:H_M_A, quoteDetectionEnabled: false, smsReminderEnabled: true}"
