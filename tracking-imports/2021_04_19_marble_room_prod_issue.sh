...
# running only chunk 102 data
nohup ./run_importer.sh -e demo -b 5726 -g ~/trashcan/marble_guests_102.csv  -r ~/trashcan/marble_resos_102.csv -c "{formatVersion:DOUBLE_FILE, separator: ',', resoDateFormat:M_D_YY,resoTimeFormat:H_MM_SS,resoCreationDate:M_D_YY, resoCreationTimeFormat:H_MM,guestDateFormat: M_D_YYYY, smsReminderEnabled: true, guestFullNameOrder:FIRST_LAST,resoFullNameOrder:FIRST_LAST, allowReimport:false}" &

nohup ./run_importer.sh -e prod -b 23731 -g ~/trashcan/marble_guests_102.csv  -r ~/trashcan/marble_resos_102.csv -c "{formatVersion:DOUBLE_FILE, separator: ',', resoDateFormat:M_D_YY,resoTimeFormat:H_MM_SS,resoCreationDate:M_D_YY, resoCreationTimeFormat:H_MM,guestDateFormat: M_D_YYYY, smsReminderEnabled: true, guestFullNameOrder:FIRST_LAST,resoFullNameOrder:FIRST_LAST, allowReimport:true}" &

# -----------------------------------------------------------------------------------------------------------------------------------------------------

nohup ./run_importer.sh -e demo -b 5734 -g ~/trashcan/marble_guests.csv  -r ~/trashcan/marble_resos.csv -c "{formatVersion:DOUBLE_FILE, separator: ',', resoDateFormat:M_D_YY,resoTimeFormat:H_M_A,resoCreationDate:M_D_YY, resoCreationTimeFormat:H_M_A,guestDateFormat: M_D_YYYY, smsReminderEnabled: true, guestFullNameOrder:FIRST_LAST,resoFullNameOrder:FIRST_LAST, allowReimport:false,startFromChunkId:102}" &

nohup ./run_importer.sh -e staging -b 24570 -g ~/trashcan/marble_guests.csv  -r ~/trashcan/marble_resos.csv -c "{formatVersion:DOUBLE_FILE, separator: ',', resoDateFormat:M_D_YY,resoTimeFormat:H_M_A,resoCreationDate:M_D_YY, resoCreationTimeFormat:H_M_A,guestDateFormat: M_D_YYYY, smsReminderEnabled: true, guestFullNameOrder:FIRST_LAST,resoFullNameOrder:FIRST_LAST, allowReimport:false,startFromChunkId:102}" &


nohup ./run_importer.sh -e staging -b 2457 -g ~/trashcan/marble_guests_subset.csv  -r ~/trashcan/marble_resos_subset.csv -c "{formatVersion:DOUBLE_FILE, separator: ',', resoDateFormat:M_D_YY,resoTimeFormat:H_M_A,resoCreationDate:M_D_YY, resoCreationTimeFormat:H_M_A,guestDateFormat: M_D_YYYY, smsReminderEnabled: true, guestFullNameOrder:FIRST_LAST,resoFullNameOrder:FIRST_LAST, allowReimport:true}" &

# TODO ESTELLE - in code, check for allowReimport = true before reassigning chunks!!!!!!!! (if its failed or success status)
# if allowReimport false, even if the status is failed, do not reimport.
